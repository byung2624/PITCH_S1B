      ...
      <div id="mlwtable" style="position: absolute; left: 50px; top 80px; visibility: visible;">
         <TABLE border=1 align="center">
			   	<TR  style="height: 100px; width: 200px;">
						<TD class="style1" align=center valign=center>
						<DIV ID="c0_cont" style="position: relative; height: 100px; width: 200px;">
							<DIV ID="c0_txt" STYLE="position: absolute; left: 0px; top: 0px; height: 100px; width: 200px; z-index: 1;">
								<p align=center valign=center><?php echo $colhead_left; ?></p>
							</DIV>
						</DIV>
						</TD>
						...
						<TD align=center valign=center>
							 <DIV ID="c0_cont" style="position: relative; height: 100px; width: 200px;">
								<DIV ID="c0_txt" STYLE="position: absolute; left: 0px; top: 0px; height: 100px; width: 200px; z-index: 1;">
									<p align=center valign=center><strong><?php echo $colhead_right; ?></strong><p>
								</DIV>
							</DIV>
						</TD>
			   </TR>
			   <TR  style="height: 100px; width: 200px;">
						<TD align=center valign=center class="actTD">
								<?php echo $text_pos_1; ?>
	 	 ...
	 	 <div style="position: absolute; top: 550px; left: 50px; width: 600px;">
		 <p align=center style="font-size:25px;"> <b>For the options listed above</b></p>
		<FORM action="save_salience.php" method="POST" >
		<TABLE width=100%>
			<div align=center>
			<TR style="text-align:center;"> Which was easier to imagine what you would spend the money on? <TR>
			</div>
		   <TR>
		   ...
		   <TR>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='spend' VALUE='1' required></td>
		...
		<TABLE width=100%>
			<TR align=center> Which seemed more vivid to you? <TR>
		   <TR>
			  <TD width=14% align=center>1</TD>
			  <TD width=14% align=center>2</TD>
			  <TD width=14% align=center>3</TD>
		   ...
		   <TR>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='vivid' VALUE='1' required></td>
		...
		<BR>
		<TABLE width=100%>
			<TR align=center>   For which do you have a more concrete plan for what to do with the money?  <TR>
		   <TR>
			  <TD width=14% align=center>1</TD>
			  <TD width=14% align=center>2</TD>
			  <TD width=14% align=center>3</TD>
		   ...
		   <TR>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='concrete' VALUE='1' required></td>
		...
		<BR>
		<TABLE width=100%>
			<TR align=center>   Which option would make you happier?  <TR>
		   <TR>
			  <TD width=14% align=center>1</TD>
			  <TD width=14% align=center>2</TD>
			  <TD width=14% align=center>3</TD>
		   ...
		   <TR>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='1' required></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='2'></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='3'></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='4'></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='5'></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='6'></td>
			  <td width=14% align=center><INPUT TYPE=RADIO NAME='happy' VALUE='7'></td>
		   </TR>
		   <TR>
			  <td width=14% align=center>Definitely<BR>Left</td>
			  <td width=14% align=center></td>
